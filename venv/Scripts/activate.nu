...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\Valles\PycharmProjects\LuluMoonwalks_SP\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\Valles\PycharmProjects\LuluMoonwalks_SP\venv\Scripts\deactivate.nu'

"""
Django settings for LuluMoonwalks project.
...
INSTALLED_APPS = [
    'LuluMoonwalks.apps.LuluAdminConfig',
    'django.contrib.auth',
...
ROOT_URLCONF = 'LuluMoonwalks.urls'
...
WSGI_APPLICATION = 'LuluMoonwalks.wsgi.application'
